...
const availability = {
  ...
  1: ["6:00 PM", "7:00 PM", "8:00 PM"], //Monday
  2: ["6:00 PM", "7:00 PM", "8:00 PM"], //Tuesday
  3: ["6:00 PM", "7:00 PM", "8:00 PM"], //Wednesday
  4: ["6:00 PM", "7:00 PM", "8:00 PM"], //Thursday
  5: ["6:00 PM", "7:00 PM", "8:00 PM"], //Friday
...
prevNextIcon.forEach((icon) => {
  icon.addEventListener("click", () => {
    ...
    if (currMonth < 0 || currMonth > 11) {
      //if current month is past december or before january
